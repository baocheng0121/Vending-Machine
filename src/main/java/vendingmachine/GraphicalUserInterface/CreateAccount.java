...
public class CreateAccount extends JFrame {
    ...
    public CreateAccount() {
        ...
        JLabel loginLabel = new JLabel("Create New Customer Account");
        ...
        loginButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                User user = SignUp.writeInFile(name, password, "customer");
                if(user != null){
                    ...
                    JOptionPane.showMessageDialog(CreateAccount.this,"User Name has been registered, try another please.");
